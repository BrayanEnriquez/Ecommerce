    ...
    <div className="min-h-screen bg-[#fbf8ff] font-['Inter'] flex flex-col items-center px-4 py-8">
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-[0_20px_40px_rgba(26,27,35,0.06)] p-8">
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#003ec7] text-white font-bold py-4 rounded-md shadow-lg shadow-[#003ec7]/20 hover:scale-[1.02] active:scale-[0.98] transition-transform"
          >
            Iniciar Sesión
          </button>
        </form>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <button className="flex items-center justify-center gap-2 py-3 bg-[#f3f2fe] rounded-md hover:bg-[#e2e1ed] transition-colors">
            <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google" className="w-5 h-5" />
            <span className="text-sm font-semibold text-[#1a1b23]">Google</span>
          </button>
          <button className="flex items-center justify-center gap-2 py-3 bg-[#f3f2fe] rounded-md hover:bg-[#e2e1ed] transition-colors">
            <img src="https://www.svgrepo.com/show/511330/apple-fill.svg" alt="Apple" className="w-5 h-5" />
            <span className="text-sm font-semibold text-[#1a1b23]">Apple</span>
          </button>
        </div>
